...
// import { ShieldCheck, UserPlus, Mail, Phone, Briefcase, Hash, User, Lock, Building, ArrowLeft, MailCheck, Loader2, Eye, EyeOff } from "lucide-react";
...
//       if (err.message?.toLowerCase().includes("limit") || err.message?.includes("3")) {
//         toast.error("Admin limit full! Redirecting to Student Signup...");
...
//           <p className="text-muted-foreground">Limited Access (Max 3 Admins)</p>
//         </div>
...
//                     <Input id="username" className="pl-9" placeholder="admin_01" value={formData.username} onChange={handleChange} required />
//                   </div>
//                 </div>
...
//                     <Input id="name" className="pl-9" placeholder="Library Head" value={formData.name} onChange={handleChange} required />
//                   </div>
//                 </div>
...
//                     <Input id="email" type="email" className="pl-9" placeholder="admin@library.com" value={formData.email} onChange={handleChange} required />
//                   </div>
//                 </div>
...
//                 <p className="text-sm font-semibold text-muted-foreground mb-4">Official Information</p>
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                   <div className="space-y-2">
//                     <Label htmlFor="designation">Admin Post</Label>
//                     <div className="relative">
//                       <Briefcase className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
//                       <Input id="designation" className="pl-9" placeholder="e.g. Chief Librarian" value={formData.designation} onChange={handleChange} required />
//                     </div>
//                   </div>
...
//                       <Input id="branch" className="pl-9" placeholder="e.g. Central Library" value={formData.branch} onChange={handleChange} required />
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//               <Button type="submit" className="w-full text-md py-6" variant="destructive" disabled={loading}>
...
//                 </div>
//                 <h2 className="text-xl font-bold">Verify Official Email</h2>
...
//                 <Button type="submit" variant="destructive" className="w-full h-12 text-md font-bold shadow-lg" disabled={loading}>
...
export default function AdminSignupPage() {
  ...
  const handleInitialSubmit = async (
    ...
    try {
      // inviteCode automatically formData ke andar ja raha hai
      await sendSignupOtp(formData);
  ...
  const handleOtpVerify = async (
    ...
    try {
      // ✅ inviteCode bhi signup request ke saath jayega
      await signup({
        ...formData,
        otp,
      });
